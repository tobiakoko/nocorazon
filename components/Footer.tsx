...
import { NAV_LINKS, NAV_SOCIALS } from "@/lib/constants";
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-20 border-b border-white/5 pb-12">
          ...
          <div className="md:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-start gap-4">
                 ...
                 <p className="text-white/60 max-w-sm font-mono text-xs leading-relaxed uppercase tracking-widest">
          ...
          <div className="md:col-span-3 md:col-start-7 flex flex-col gap-6">
            ...
            <ul className="space-y-4">
                {NAV_LINKS.map((link) => (
                    <li key={link.href}>
                        <a href={link.href} className="group flex items-center gap-2 text-white/60 hover:text-white transition-colors">
                            <span className="w-0 group-hover:w-2 h-[1px] bg-brand-pink transition-all duration-300" />
                            <span className="font-display font-bold text-xl uppercase tracking-widest">{link.label}</span>
            ...
            <div>
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] text-white/60 uppercase tracking-widest">Contact</span>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 pt-4">
            ...
            <div className="hidden md:flex flex-col items-end">
                <span className="text-[10px] text-brand-pink/60 font-mono tracking-widest">BOOKINGS</span>
